...
export default function FoodTracker() {
  ...
  const handleUpdateMeal = () => {
    dispatch({ type: 'UPDATE_MEAL_ENTRY', payload: { id: editingMeal.id, updates: editingMeal } });
    setEditingMeal(null);
    setShowMealDialog(false);
  };
  ...
  const handleDeleteWater = (id) => {
    dispatch({ type: 'DELETE_WATER_ENTRY', payload: id });
  };

  const handleUpdateGoals = () => {
    dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: goals });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Monitor your nutrition and hydration goals
          </p>
        </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: { daily_calories: parseInt(e.target.value) } })}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: { daily_protein: parseInt(e.target.value) } })}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: { daily_carbs: parseInt(e.target.value) } })}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: { daily_fat: parseInt(e.target.value) } })}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: { daily_water: parseInt(e.target.value) } })}
                    />
                  </div>
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => dispatch({ type: 'UPDATE_NUTRITION_GOALS', payload: { water_unit: value } })}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          if (editingMeal) {
                            ...
                            setNewMeal({ ...newMeal, fat: parseInt(e.target.value) || 0 });
                          }
                        }}
                      />
                    </div>
