...
export default function Home() {
  ...
  const totalActive = userHabits.length;
  const currentStreak = Math.max(...userHabits.map(h => h.streak_current || 0), 0);
  const weeklyProgress = totalActive > 0 ? (completedToday / totalActive) * 100 : 0;
